package com.transdignity.deathserviceprovider.fcm;
...
import com.transdignity.deathserviceprovider.activities.SplashActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.v("responseUser", body.toString());
        ...
        if (remoteMessage.getNotification() != null) {
           ...
           // Log.e("Notification Body: " ,type+ remoteMessage.getData()+"");
            ...
            Log.v("responseUser", remoteMessage.getNotification().getBody() + "");
    ...
    public void notificationManage(String remoteMessage) {
        ...
        try {
           ...
           // Log.v("responseUser", object.toString());

            MyConstants.isFromNotification = true;
            //It should be notification type
           // notification_type = object.getString("notificaton_type");
            if (notification_type.equals("New Task Assigned.")) {
