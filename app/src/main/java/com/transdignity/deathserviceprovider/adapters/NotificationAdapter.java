...
import com.transdignity.deathserviceprovider.databinding.NotificationListDesignBinding;
...
holder.binding.tvDate.setText(dataItems.get(i).getNotificationTimestamp());
    }
