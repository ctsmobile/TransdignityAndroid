...
public class CasketServiceFragment extends Fragment implements View.OnClickListener {
    View view;
    Data data;
    ...
    EditText ed_sender_first_name,ed_sender_last_name,ed_sender_mobile_no,
            ed_date,ed_receiver_first_name,ed_receiver_last_name,ed_receiver_mobile_no,ed_description;
    ...
    public CasketServiceFragment() {
        // Required empty public constructor
    }


    public static CasketServiceFragment newInstance(Data data, Boolean isViewMode) {
        CasketServiceFragment fragment = new CasketServiceFragment();
        fragment.data = data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_casket_service, container, false);
        init();
    ...
    public void validation(){
        if (TextUtils.isEmpty(tv_pick_up_location.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Pick up Location",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_sender_first_name.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Sender First Name",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_sender_last_name.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Sender Last Name",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_sender_mobile_no.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Sender Mobile No",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }/*else if (TextUtils.isEmpty(tv_start_date.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Select Date ",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(tv_select_time.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Select Time ",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }*/else if (TextUtils.isEmpty(tv_drop_location.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Drop Location",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_receiver_first_name.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Receiver First Name",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_receiver_last_name.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Receiver Last Name",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_receiver_mobile_no.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Receiver Mobile No",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else if (TextUtils.isEmpty(ed_description.getText().toString())){
            Snackbar.make(view.findViewById(R.id.ll_casket),"Please Enter Description",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        }else {
            CasketServiceApi();
        }
    ...
    public void CasketServiceApi() {
        ...
        final CasketRequestModel req = new CasketRequestModel();
       ...
       // req.setI(ed_description.getText().toString().trim());
        req.setServiceId(3);

        Call<CasketResponseModel> call = apiInterface.CasketServiceApi(loginResponse.getData().getToken(), req);

        call.enqueue(new Callback<CasketResponseModel>() {
            @Override
            public void onResponse(Call<CasketResponseModel> call, Response<CasketResponseModel> response) {
                dialog.dismiss();
                try {
                        ...
                        if (response.body().getSuccess().equalsIgnoreCase("true")) {
                           ...
                           /* String req_sent_driver=response.body().getData().getRequestSentTodriver();
                            if(req_sent_driver.equals("1")){
                                ...
                                Fragment fragment = CasketDetailsPageFragment.newInstance(requesrId,"Casket");
            ...
            @Override
            public void onFailure(Call<CasketResponseModel> call, Throwable t) {
                    ...
                    if (response.code() >= 200 && response.code() <= 210) {
                        ...
                        try {
                            ...
                            if(status.equals("notresponded")){
                                ...
                                ll_submit.setEnabled(true);
                                count=0;
                                Fragment fragment = new CasketServiceFragment();
                                String fragmtStatusTag2 = fragment.getClass().getName();
                                GlobalValues.getInstance().setFramgentTag(fragmtStatusTag2);
                                ((MainActivity) activity).selectedNavItem(R.id.navigation_home);
                                CommonUtils.loadFragment(context, fragment, fragmtStatusTag2);
