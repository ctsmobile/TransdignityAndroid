...
public class LimoDetailsFormPageFragment extends Fragment {
    View view;
    String requestid;
    Context context;
    Activity activity;
    LoginResponse loginResponse;
    TextView tv_descendant_name,tv_back,tv_date,tv_pick_up_location,tv_drop_location,tv_duration,tv_trip_type,tv_mobile_no,tv_comments;

    public LimoDetailsFormPageFragment() {
        // Required empty public constructor
    }


    public static LimoDetailsFormPageFragment newInstance(String id) {
        LimoDetailsFormPageFragment fragment = new LimoDetailsFormPageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_details_form_page, container, false);
    ...
    public void init(){
        ...
        tv_trip_type=view.findViewById(R.id.tv_trip_type);
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment2;
                fragment2 =  LimoDetailPageFragment.newInstance(requestid,"Home");
                ...
                try {
                    ...
                    if (response.code() >= 200 && response.code() <= 210) {
                        if (response.body().getSuccess().equalsIgnoreCase("true")) {
                            ...
                            tv_descendant_name.setText(name);
                            tv_pick_up_location.setText(response.body().getData().getPickupLocation());
                            tv_drop_location.setText(response.body().getData().getDropLocation());
                            tv_duration.setText(response.body().getData().getDuration());
                            tv_mobile_no.setText(response.body().getData().getMobileNumber());
                            tv_trip_type.setText(response.body().getData().getTripType());
                            tv_date.setText(response.body().getData().getRequestDate());
                            tv_comments.setText(response.body().getData().getDescription());
