...
public class FlowerDetailFormPageFragment extends Fragment {
    View view;
    String requestid;
    Context context;
    Activity activity;
    LoginResponse loginResponse;
    TextView tv_back,tv_date,tv_flower_name,tv_quantity,tv_decendent_name,tv_mobile_no,tv_address,tv_comments;

    public FlowerDetailFormPageFragment() {
        // Required empty public constructor
    }


    public static FlowerDetailFormPageFragment newInstance(String id) {
        FlowerDetailFormPageFragment fragment = new FlowerDetailFormPageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_flower_detail_form_page, container, false);
    ...
    public void init(){
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment2;
                fragment2 =  FlowerDetailPageFragment.newInstance(requestid,"Home");
                ...
                try {
                    ...
                    if (response.code() >= 200 && response.code() <= 210) {
                        if (response.body().getSuccess().equalsIgnoreCase("true")) {
                            ...
                            tv_quantity.setText(response.body().getData().getQuantity());
