...
public class CasketViewDetialPageFragment extends Fragment {
    View view;
    String requestid;
    Context context;
    Activity activity;
    LoginResponse loginResponse;
    TextView tv_back,tv_pickup_location,tv_sender_name,tv_sender_mobile_no,tv_drop_location,
             tv_receiver_name,tv_receiver_mobile_no,tv_description,tv_date;
    public CasketViewDetialPageFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static CasketViewDetialPageFragment newInstance(String id) {
        CasketViewDetialPageFragment fragment = new CasketViewDetialPageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_casket_view_detial_page, container, false);
    ...
    public void init(){
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment2;
                fragment2 =  CasketDetailsPageFragment.newInstance(requestid,"Home");
