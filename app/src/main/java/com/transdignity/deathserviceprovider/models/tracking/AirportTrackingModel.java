...
public class AirportTrackingModel {
    ...
    public class Data {
        ...
        @SerializedName("cab_driver_assign_time_airpoert")
        private String mCabDriverAssignTimeAirpoert;
        @SerializedName("decendant_name")
        private String mDecendantName;
        @SerializedName("drop_airport_time")
        private String mDropAirportTime;
        ...
        @SerializedName("pickup_decendent_time_airport")
        private String mPickupDecendentTimeAirport;
        @SerializedName("pickup_rs_time")
        private String mPickupRsTime;
        @SerializedName("pickup_rs_time_airport")
        private String mPickupRsTimeAirport;
        @SerializedName("reached_on_airport_pickup_location_time")
        private String mReachedOnAirportPickupLocationTime;
        ...
        @SerializedName("reached_on_rs_location_time_airport")
        private String mReachedOnRsLocationTimeAirport;
        @SerializedName("removal_assign_time_airpoert")
        private String mRemovalAssignTimeAirpoert;
        ...
        public String getCabDriverAssignTimeAirpoert() {
            return mCabDriverAssignTimeAirpoert;
        }

        public void setCabDriverAssignTimeAirpoert(String cabDriverAssignTimeAirpoert) {
            mCabDriverAssignTimeAirpoert = cabDriverAssignTimeAirpoert;
        }
        ...
        public String getDropAirportTime() {
            return mDropAirportTime;
        }

        public void setDropAirportTime(String dropAirportTime) {
            mDropAirportTime = dropAirportTime;
        }
        ...
        public String getPickupDecendentTimeAirport() {
            return mPickupDecendentTimeAirport;
        }

        public void setPickupDecendentTimeAirport(String pickupDecendentTimeAirport) {
            mPickupDecendentTimeAirport = pickupDecendentTimeAirport;
        }
        ...
        public String getPickupRsTimeAirport() {
            return mPickupRsTimeAirport;
        }

        public void setPickupRsTimeAirport(String pickupRsTimeAirport) {
            mPickupRsTimeAirport = pickupRsTimeAirport;
        }

        public String getReachedOnAirportPickupLocationTime() {
            return mReachedOnAirportPickupLocationTime;
        }

        public void setReachedOnAirportPickupLocationTime(String reachedOnAirportPickupLocationTime) {
            mReachedOnAirportPickupLocationTime = reachedOnAirportPickupLocationTime;
        }
        ...
        public String getReachedOnRsLocationTimeAirport() {
            return mReachedOnRsLocationTimeAirport;
        }

        public void setReachedOnRsLocationTimeAirport(String reachedOnRsLocationTimeAirport) {
            mReachedOnRsLocationTimeAirport = reachedOnRsLocationTimeAirport;
        }

        public String getRemovalAssignTimeAirpoert() {
            return mRemovalAssignTimeAirpoert;
        }

        public void setRemovalAssignTimeAirpoert(String removalAssignTimeAirpoert) {
            mRemovalAssignTimeAirpoert = removalAssignTimeAirpoert;
        }
