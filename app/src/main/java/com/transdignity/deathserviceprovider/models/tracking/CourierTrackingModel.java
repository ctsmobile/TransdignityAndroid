...
public class CourierTrackingModel {
    ...
    public class Data {
        ...
        @SerializedName("courier_drop_time")
        private Object mCourierDropTime;
        @SerializedName("courier_pickup_time")
        private Object mCourierPickupTime;
        ...
        public Object getCourierDropTime() {
            return mCourierDropTime;
        }

        public void setCourierDropTime(Object courierDropTime) {
            mCourierDropTime = courierDropTime;
        }

        public Object getCourierPickupTime() {
            return mCourierPickupTime;
        }

        public void setCourierPickupTime(Object courierPickupTime) {
            mCourierPickupTime = courierPickupTime;
        }
