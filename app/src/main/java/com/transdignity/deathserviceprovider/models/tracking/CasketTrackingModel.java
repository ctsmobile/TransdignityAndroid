...
public class CasketTrackingModel {
    ...
    public class Data {
        ...
        @SerializedName("casket_drop_time")
        private Object mCasketDropTime;
        @SerializedName("casket_pickup_time")
        private Object mCasketPickupTime;
        ...
        public Object getCasketDropTime() {
            return mCasketDropTime;
        }

        public void setCasketDropTime(Object casketDropTime) {
            mCasketDropTime = casketDropTime;
        }

        public Object getCasketPickupTime() {
            return mCasketPickupTime;
        }

        public void setCasketPickupTime(Object casketPickupTime) {
            mCasketPickupTime = casketPickupTime;
        }
