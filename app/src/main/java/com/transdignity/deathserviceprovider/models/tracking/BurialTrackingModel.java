...
public class BurialTrackingModel {
    ...
    public class Data {
        ...
        @SerializedName("boat_driver_assign_time")
        private String mBoatDriverAssignTime;
        ...
        @SerializedName("drop_decendant_time_boat")
        private String mDropDecendantTimeBoat;
        @SerializedName("pickup_body_time_boat")
        private String mPickupBodyTimeBoat;
        ...
        @SerializedName("boat_driver_reachedbody_time")
        private String mBoatDriverReachedbodyTime;
        @SerializedName("burial_time_insea")
        private String mBurialTimeInsea;

        public String getBoatDriverAssignTime() {
            return mBoatDriverAssignTime;
        }

        public void setBoatDriverAssignTime(String boatDriverAssignTime) {
            mBoatDriverAssignTime = boatDriverAssignTime;
        }
        ...
        public String getDropDecendantTimeBoat() {
            return mDropDecendantTimeBoat;
        }

        public void setDropDecendantTimeBoat(String dropDecendantTimeBoat) {
            mDropDecendantTimeBoat = dropDecendantTimeBoat;
        }

        public String getPickupBodyTimeBoat() {
            return mPickupBodyTimeBoat;
        }

        public void setPickupBodyTimeBoat(String pickupBodyTimeBoat) {
            mPickupBodyTimeBoat = pickupBodyTimeBoat;
        }
        ...
        public String getBoatDriverReachedbodyTime() {
            return mBoatDriverReachedbodyTime;
        }

        public void setBoatDriverReachedbodyTime(String BoatDriverReachedbodyTime) {
            this.mBoatDriverReachedbodyTime = BoatDriverReachedbodyTime;
        }

        public String getBurialTimeInsea() {
            return mBurialTimeInsea;
        }

        public void setBurialTimeInsea(String BurialTimeInsea) {
            this.mBurialTimeInsea = BurialTimeInsea;
        }
    }
    public class Error {
