...
import com.transdignity.driver.databinding.ActivitySignupBinding;
...
public class SignupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.llExpDate.setOnClickListener(this);
        binding.etExperienceDate.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.step3_btn:
                ...
                break;
                case R.id.ll_exp_date:
                    getDatepicker(SignupActivity.this, binding.etExperienceDate);

                    break;
                    case R.id.et_experience_date:
                    getDatepicker(SignupActivity.this, binding.etExperienceDate);
    ...
    void step1Validation() {
        if (TextUtils.isEmpty(binding.etYearOfDrivingExper.getText().toString().trim())) {
            binding.etYearOfDrivingExper.setError("Please enter Year Of Driving Experience!");
            binding.etYearOfDrivingExper.requestFocus();
        ...
        } else if (TextUtils.isEmpty(binding.etExperienceDate.getText().toString().trim())) {
            binding.etExperienceDate.setError("Please enter Experience Date!");
            binding.etExperienceDate.requestFocus();
    ...
    void step2Validation() {
        ...
        } else if (binding.etPriOfficePhone.getText().toString().trim().length() < 10 || binding.etPriOfficePhone.getText().toString().trim().length() > 15) {
        ...
        } else if (binding.etpriCellPhone.getText().toString().trim().length() < 10 || binding.etpriCellPhone.getText().toString().trim().length() > 15) {
            binding.etpriCellPhone.setError("Please enter Valid Cell Phone!");
            binding.etpriCellPhone.requestFocus();
        } else if (TextUtils.isEmpty(binding.etPriAddress.getText().toString().trim())) {
            binding.etPriAddress.setError("Please enter Address!");
            binding.etPriAddress.requestFocus();
        }  else {
            step3ContainerVisible();
        }
    }
    ...
    void step3Validation() {
        if (TextUtils.isEmpty(binding.etSecContName.getText().toString().trim())) {
        ...
        } else if (binding.etSecOfficePhone.getText().toString().trim().length() < 10 || binding.etSecOfficePhone.getText().toString().trim().length() > 15) {
        ...
        } else if (binding.etSecCellPhone.getText().toString().trim().length() < 10 || binding.etSecCellPhone.getText().toString().trim().length() > 15) {
            ...
            binding.etSecEmail.setError("Please enter Secondary Email!");
    ...
    void callSignUpApi() {
        ...
        request.setUserGroupId("4");
        request.setYearOfExperience(binding.etYearOfDrivingExper.getText().toString().trim());
        request.setAddress(binding.etPriAddress.getText().toString().trim());
        request.setLicenseNumber(binding.etLicense.getText().toString().trim());
        request.setExpirationDate(binding.etExperienceDate.getText().toString().trim());
        ...
        request.setPrimaryAddress(binding.etPriAddress.getText().toString().trim());
