...
public class AshesViewDetialPageFragment extends Fragment {
    View view;
    String requestid,service_id;
    Context context;
    Activity activity;
    LoginResponse loginResponse;
    TextView tv_back,tv_date,tv_pickup_location,tv_drop_location,tv_descendant_name,tv_mobile_no,tv_comments;



    public AshesViewDetialPageFragment() {
        // Required empty public constructor
    }


    public static AshesViewDetialPageFragment newInstance(String id,String service_id) {
        AshesViewDetialPageFragment fragment = new AshesViewDetialPageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_ashes_view_detial_page, container, false);
    ...
    public void init(){
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment2;
                fragment2 =  DecendentDetailFragment.newInstance(requestid,service_id);
